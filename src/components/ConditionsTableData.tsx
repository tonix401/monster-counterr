...
const ConditionsTableData: React.FC<ConditionsTableDataProps> = ({ monster }) => {
  ...
  const remainingConditions = [...CONDITIONS].sort().filter((c: string) => !monster.conditions.includes(c));
    ...
    <td>
      <div className="conditions-container">
        ...
        {remainingConditions.length > 0 && (
          <select className="add-condition-tag" onChange={handleAddCondition} defaultValue="">
